...
namespace DialogFramework.UniversalModel
{
    public partial record DialogContext
    {
        ...
        public IDialogContext Start(IDialogPart firstPart)
            => new DialogContext(Id, CurrentDialogIdentifier, firstPart, (firstPart as IGroupedDialogPart)?.Group, firstPart.State, new ValueCollection<IDialogPartResult>(), null);
        ...
        public IDialogContext NavigateTo(IDialogPart navigateToPart)
            => new DialogContext(Id, CurrentDialogIdentifier, navigateToPart, (navigateToPart as IGroupedDialogPart)?.Group, navigateToPart.State, Answers, null);
