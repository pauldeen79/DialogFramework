...
internal static class DialogFixture
{
    internal static Dialog CreateDialog(bool addParts = true)
    {
        ...
        var answerGreat = new QuestionDialogPartResult("Great", "I feel great, thank you!", AnswerValueType.None);
        var answerOkay = new QuestionDialogPartResult("Okay", "I feel kind of okay", AnswerValueType.None);
        var answerTerrible = new QuestionDialogPartResult("Terrible", "I feel terrible, don't want to talk about it", AnswerValueType.None);
