...
public class SingleOptionalQuestionDialogPartTests
{
    ...
    public void No_Answers_Gives_No_ValidationError()
    {
        ...
        var sut = new QuestionDialogPart("Test", "Max 1 answer", "Title", group, new[] { new DialogPartResultDefinition("A", "First", ResultValueType.YesNo), new DialogPartResultDefinition("B", "Second", ResultValueType.YesNo) }, new IQuestionDialogPartValidator[] { new SingleOptionalQuestionDialogPartValidator() });
