...
public class QuestionDialogPartTests
{
    ...
    public void Validate_With_Unknown_Id_Gives_ValidationError()
    {
        ...
        var sut = new QuestionDialogPart("Test", "Give me an answer!", "Title", group, new[] { new DefaultDialogPartResultDefinition("A", "First", ResultValueType.YesNo), new DefaultDialogPartResultDefinition("B", "Second", ResultValueType.YesNo) });
