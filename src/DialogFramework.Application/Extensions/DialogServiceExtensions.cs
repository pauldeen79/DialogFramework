...
{
    public static IDialog Continue(this IDialogApplicaionService instance, IDialog dialog)
    ...
    public static IDialog Continue(this IDialogApplicaionService instance, IDialog dialog, params IDialogPartResult[] results)
