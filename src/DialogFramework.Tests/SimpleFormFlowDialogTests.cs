...
public sealed class SimpleFormFlowDialogTests : IDisposable
{
    ...
    {
        // Arrange
        var dialog = _provider.GetRequiredService<IDialogDefinitionRepository>().GetDialog(new DialogDefinitionIdentifier(nameof(SimpleFormFlowDialog), "1.0.0"))!;
    ...
    {
        // Arrange
        var dialog = new TestDialogDefinitionRepository().GetDialog(new DialogDefinitionIdentifier(nameof(SimpleFormFlowDialog), "1.0.0"));
