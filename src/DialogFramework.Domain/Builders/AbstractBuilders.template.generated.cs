...
namespace DialogFramework.Domain.Builders
{
        ...
        where TBuilder : DialogPartBuilder<TBuilder, TEntity>
    {
        ...
        public static implicit operator DialogFramework.Domain.DialogPart(DialogPartBuilder<TBuilder, TEntity> entity)
        {
        ...
        where TBuilder : DialogPartResultBuilder<TBuilder, TEntity>
    {
        ...
        public static implicit operator DialogFramework.Domain.DialogPartResult(DialogPartResultBuilder<TBuilder, TEntity> entity)
        {
            return entity.BuildTyped();
        }
    }
        ...
        where TBuilder : ValidationRuleBuilder<TBuilder, TEntity>
    {
        ...
        public static implicit operator DialogFramework.Domain.ValidationRule(ValidationRuleBuilder<TBuilder, TEntity> entity)
        {
            return entity.BuildTyped();
        }
    }
