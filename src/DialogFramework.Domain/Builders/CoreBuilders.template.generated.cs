...
namespace DialogFramework.Domain.Builders
{
    public partial class ClosedQuestionOptionBuilder
    {
        ...
        public static implicit operator DialogFramework.Domain.ClosedQuestionOption(ClosedQuestionOptionBuilder entity)
        {
            return entity.Build();
        }
    ...
    public partial class DialogBuilder
    {
        ...
        public static implicit operator DialogFramework.Domain.Dialog(DialogBuilder entity)
        {
            return entity.Build();
        }
    ...
    public partial class DialogDefinitionBuilder
    {
        ...
        public static implicit operator DialogFramework.Domain.DialogDefinition(DialogDefinitionBuilder entity)
        {
            return entity.Build();
        }
    ...
    public partial class DialogPartSectionBuilder
    {
        ...
        public static implicit operator DialogFramework.Domain.DialogPartSection(DialogPartSectionBuilder entity)
        {
            return entity.Build();
        }
